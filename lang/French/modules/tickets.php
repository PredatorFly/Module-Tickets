...
define('ticket_attachment_invalid_size', "%1 est plus gros que la taille de fichier autorisée: %2 octets maximum!");
define('ticket_max_file_elements', "Un maximum de %1 élément de fichier peut exister.");
...
define('attachment_err_no_tmp', "Aucun répertoire temporaire n'existe pour sauvegarder %s");
...
define('attachment_save_dir_info', "Défini où les pièces jointes doivent être envoyées. Idéalement, en dehors du dossier public_html ou de l'accès direct bloqué.");
...
define('invalid_unit', "Unité invalide  pour le paramètre Taille Maximum des Fichiers. Unité attendues: KB, MB, GB, TB, ou PB.");
